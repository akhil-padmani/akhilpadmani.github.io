...
if(isset($_POST['submit'])){
   ...
   else
   {
      ...
      {
         $insert ="INSERT INTO `users`(name, email, password, user_type) VALUES('$name', '$email', '$cpass', '$user_type')" or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="POST">
      ...
      <select name="user_type"  class="box" style="width:90%;">
